        ...
        <div id="content">
            ...
            <form runat="server">
                ...
                <div>
                    ...
                    <div class="blogItems">
                        <asp:GridView ID="gvJoyFulWPF" runat="server" DataSourceID="JoyfulWPFObjectDataSource"
                            AutoGenerateColumns="False" ShowHeader="False"
                            BorderWidth="0px" BackColor="Transparent" GridLines="None" 
                            AlternatingRowStyle-BorderWidth="0px" EnableViewState="false" 
